...
const baseUrl = 'https://nissanhub-stage.designory.com/trucks/frontier';
...
describe('Verify URLs for CTAs on Off-road Capability', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/frontier/nissan-frontier/index.html');
      cy.visit(fullUrl).get('[aria-label="Towing"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/frontier/frontier-towing/index.html');
      cy.visit(fullUrl).get('[aria-label="Utility & Safety Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/frontier/frontier-utility-safety-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Interior & Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/frontier/frontier-interior-tech/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

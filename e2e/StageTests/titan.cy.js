...
const baseUrl = 'https://nissanhub-stage.designory.com/trucks/titan';
...
describe('Verify URLs for CTAs on Off-road', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/titan/nissan-titan/index.html');
      cy.get('[aria-label="Towing"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/titan/titan-towing/index.html');
      cy.visit(fullUrl).get('[aria-label="Utility & Safety Tech"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/titan/titan-utility-safety/index.html');
      cy.visit(fullUrl).get('[aria-label="Interior & Tech"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/trucks/titan/titan-interior-tech/index.html');
      cy.visit(fullUrl);
    // Take the Next Step

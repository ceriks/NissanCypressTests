...
const baseUrl = 'https://nissanhub-stage.designory.com/sportscars/gtr';
...
describe('Verify URLs for CTAs on Performance', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/gtr/nissan-gt-r/index.html');
      cy.visit(fullUrl).get('[aria-label="Aerodynamics & Design"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/gtr/gt-r-aerodynamics/index.html');
      cy.visit(fullUrl).get('[aria-label="Technology & Interior"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/gtr/gt-r-technology/index.html');
      cy.visit(fullUrl).get('[aria-label="NISMO®"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/gtr/gt-r-nismo/index.html');
      cy.visit(fullUrl).get('[aria-label="Craftsmanship"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/gtr/gt-r-craftsmanship/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

...
const baseUrl = 'https://nissanhub-stage.designory.com/cars/altima';
...
describe('Verify URLs for CTAs on Performance & Handling', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/altima/nissan-altima/index.html');
      cy.visit(fullUrl).get('[aria-label="Technology"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/altima/altima-technology/index.html');
      cy.visit(fullUrl).get('[aria-label="Driver Assist & Safety Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/altima/altima-driver-assist-safety-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Style & Interior"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/altima/altima-style-interior/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

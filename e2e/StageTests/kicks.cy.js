// Model & Year: Kicks 2025
const baseUrl = 'https://nissanhub-stage.designory.com/suvs/kicks';
...
describe('Verify URLs for CTAs on Capability & Performance', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/kicks/nissan-kicks/index.html');
      cy.visit(fullUrl).get('[aria-label="Interior & Cargo"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/kicks/kicks-interior-cargo/index.html');
      cy.visit(fullUrl).get('[aria-label="Technology"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/kicks/kicks-technology/index.html');
      cy.visit(fullUrl).get('[aria-label="Driver Assist"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/kicks/kicks-driver-assist/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

...
const baseUrl = 'https://nissanhub-stage.designory.com/cars/sentra';
...
describe('Verify URLs for CTAs on Style', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/sentra/nissan-sentra/index.html');
      cy.get('[aria-label="Interior"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/sentra/sentra-interior/index.html');
      cy.visit(fullUrl).get('[aria-label="Performance & Safety Tech"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/sentra/sentra-performance-safety-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Technology"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/cars/sentra/sentra-technology/index.html');
      cy.visit(fullUrl);
    // Take the Next Step

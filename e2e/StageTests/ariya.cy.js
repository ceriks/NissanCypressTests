...
const baseUrl = 'https://nissanhub-stage.designory.com/electric-hybrid-cars/ariya';
...
describe('Verify URLs for CTAs on Interior', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/electric-hybrid-cars/ariya/nissan-ariya/index.html');
      cy.visit(fullUrl).get('[aria-label="Connect"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/electric-hybrid-cars/ariya/ariya-connect/index.html');
      cy.visit(fullUrl).get('[aria-label="Performance & Safety Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/electric-hybrid-cars/ariya/ariya-performance-and-safety-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Range and Charging"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/electric-hybrid-cars/ariya/ariya-range-and-charging/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

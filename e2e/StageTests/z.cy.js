// Model Year: Z2025
const baseUrl = 'https://nissanhub-stage.designory.com/sportscars/nissan-z';
...
describe('Verify URLs for CTAs on Performance', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/nissan-z/nissan-z/index.html');
      cy.get('[aria-label="Interior & Tech"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/nissan-z/z-interior/index.html');
      cy.visit(fullUrl).get('[aria-label="Design"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/nissan-z/z-design/index.html');
      cy.visit(fullUrl).get('[aria-label="NISMO®"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/sportscars/nissan-z/z-nismo/index.html');
      cy.visit(fullUrl);
    // Take the Next Step

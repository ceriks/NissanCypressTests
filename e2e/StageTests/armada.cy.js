...
const baseUrl = 'https://nissanhub-stage.designory.com/suvs/armada';
...
describe('Verify URLs for CTAs on Performance & Capability', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/armada/nissan-armada/index.html');
      cy.visit(fullUrl).get('[aria-label="Driver Assist & Safety Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/armada/nissan-armada-driver-assist-safety-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Connectivity & Technology"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/armada/nissan-armada-connectivity-technology/index.html');
      cy.visit(fullUrl).get('[aria-label="Interior Comfort & Cargo"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-stage.designory.com/suvs/armada/nissan-armada-interior-comfort-cargo/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

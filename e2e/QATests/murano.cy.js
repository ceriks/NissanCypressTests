...
const baseUrl = 'https://nissanhub-qa.designory.com/suvs/murano';
...
describe('Verify URLs for CTAs on Interior & Cargo', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/murano/nissan-murano/index.html');
      cy.visit(fullUrl).get('[aria-label="Technology"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/murano/murano-technology/index.html');
      cy.visit(fullUrl).get('[aria-label="Driver Assist & Cargo"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/murano/murano-drive-assist-cargo/index.html');
      cy.visit(fullUrl).get('[aria-label="Effortless Performance"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/murano/murano-performance/index.html');
    // Take the Next Step
      cy.visit(fullUrl);

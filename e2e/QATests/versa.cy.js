...
const baseUrl = 'https://nissanhub-qa.designory.com/cars/versa';
...
describe('Verify URLs for CTAs on Interior', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/cars/versa/nissan-versa/index.html');
      cy.get('[aria-label="Technology"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/cars/versa/versa-technology/index.html');
      cy.visit(fullUrl).get('[aria-label="Drive Tech"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/cars/versa/versa-drive-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Design"] > .cta-thumb-img > .ajax-media-view').click()
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/cars/versa/versa-design/index.html');
      cy.visit(fullUrl);
    // Take the Next Step

...
const baseUrl = 'https://nissanhub-qa.designory.com/suvs/rogue';
...
describe('Verify URLs for CTAs on Performance', () => {
  ...
  it(`should visit ${link} and verify internal URLs`, () => {
    ...
    // Keep Exploring
      ...
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/rogue/nissan-rogue/index.html');
      cy.visit(fullUrl).get('[aria-label="Interior & Capacities"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/rogue/rogue-interior-capacities/index.html');
      cy.visit(fullUrl).get('[aria-label="Connectivity & Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/rogue/rogue-connectivity-tech/index.html');
      cy.visit(fullUrl).get('[aria-label="Driver Assist & Safety Tech"]').click();
      cy.wait(1000);
      cy.url().should('eq', 'https://nissanhub-qa.designory.com/suvs/rogue/rogue-driver-assist-safety/index.html');
    // Take the Next Step
      cy.visit(fullUrl);
